...
<title>商城后台管理中心 - 添加系统管理员用户</title>
...
<script type="text/javascript">
	...
	function saveData() {
		...
		$("#addSysAdminForm").ajaxSubmit({
			...
			async : true,//异步
			url : "${contextPath}/servlet/UserServlet?task=addSysAdmin&date=" + Math.random() + "", /*设置post提交到的页面*/
	...
	<div id="dcWrap">
		...
		<div id="dcMain">
			...
			<div id="urHere">
				商城后台管理中心
				<b>></b>
				<strong>添加系统用户</strong>
			</div>
			<div class="mainBox" style="height: auto !important; height: 550px; min-height: 550px;">
				<h3>
					<a href="${contextPath}/servlet/UserServlet?task=sysList" class="actionBtn">系统用户管理</a>
					添加系统用户
				</h3>
				<form id="addSysAdminForm" action="#" method="post" enctype="multipart/form-data">
