	...
	<div id="dcWrap">
		...
		<div id="dcMain">
			...
			<div class="mainBox" style="height: auto !important; height: 550px; min-height: 550px;">
				<h3>
					<a href="${contextPath}/admin/user/addreguser.jsp" class="actionBtn add">添加注册用户</a>
					注册用户列表
				</h3>
				<div class="filter">
					<form action="${contextPath}/servlet/UserServlet?task=regList" method="post">
						&nbsp;&nbsp;用户名：
						<input name="p_regusername" type="text" class="inpMain" value="${p_regusername}" size="20" />
						&nbsp;&nbsp;真实姓名：
						<input name="p_regrealname" type="text" class="inpMain" value="${p_regrealname}" size="20" />
